...
#Load a data file
df1 = pd.read_csv("AUSUSD-1969-2009.csv", #to read CSV file into df = DataFrame.
		sep=",", 
...
DATERANGE = df1.loc['1970-01-01':'2009-01-01']
...
plt.savefig('AUSUSD-1969-2009.pdf')
#plt.savefig('AUSUSD-1969-2009a.png', dpi=72)
plt.savefig('AUSUSD-1969-2009b.png', dpi=300)
plt.savefig('AUSUSD-1969-2009c.png', dpi=600) #Save files in multiple resolution at once.
plt.show()
