...
#Data Save Section
plt.savefig('CashRate-1990--xx.pdf')
plt.savefig('CashRate-1990--xxb.png', dpi=300)
plt.savefig('CashRate-1990--xxc.png', dpi=600) #Save files in multiple resolution at once.
plt.show()