...
DATERANGE = DFMerge.loc['1985-01-01':'2010-11-01']
...
print(FEDFUNDSDF.info())
print(FEDFUNDSDF)
FEDFUNDSDF = FEDFUNDSDF.loc['1985-01-01':'2010-11-01']
print(FEDFUNDSDF.info())
print(FEDFUNDSDF)
print("\nWell done, you finished the checking part.\n")
...
ax1.plot(DATERANGE.index, DATERANGE["FXRUSD"], color ='orange', label ='AUDUSD')
ax1.set_ylabel('AUDUSD', color='orange')
...
#Data Save Section
plt.savefig('AUDvsFFRate1985-2010a.pdf')
plt.savefig('AUDvsFFRate1985-2010b.png', dpi=300)
plt.savefig('AUDvsFFRate1985-2010c.png', dpi=600) #Save files in multiple resolution at once.
plt.show()
